<template>
    <div class="view-container">
        ...
        <demo-card title="Badge 徽标">
            <badge-demo></badge-demo>
        </demo-card>
        <demo-card title="Marquee 跑马灯">
            <marquee-demo></marquee-demo>
        </demo-card>
        <demo-card title="Infinite Scroll 无限滚动">
            <infinite-scroll-demo></infinite-scroll-demo>
        </demo-card>
        <demo-card title="Collapse 折叠面板">
            <collapse-demo></collapse-demo>
        </demo-card>
        <demo-card title="Progress 进度条">
    ...
    <teleport to="#outline">
        <ul class="outline-list">
            ...
            <li><a href="#Infinite Scroll 无限滚动">Infinite Scroll 无限滚动</a></li>
            <li><a href="#Collapse 折叠面板">Collapse 折叠面板</a></li>
            <li><a href="#Progress 进度条">Progress 进度条</a></li>
            <li><a href="#Empty 空状态">Empty 空状态</a></li>
        </ul>
    </teleport>
</template>
