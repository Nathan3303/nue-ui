...
```html
<link rel="stylesheet" href="node_modules/nue-ui-iconfont/dist/iconfont.css" />
```
...
1. **样式引入**: 使用图标前必须先引入 CSS 文件
2. **字体加载**: 字体文件需要从正确的路径加载
3. **类名规范**: 必须同时使用 `iconfont` 和对应的图标类名
4. **性能优化**: 建议使用 WOFF2 格式以获得最佳性能

## 相关链接

- [GitHub 仓库](https://github.com/Nathan3303/nue-ui)
- [在线文档](https://nathan3303.github.io/nue-ui/)
- [图标预览](https://nathan3303.github.io/nue-ui/icon)