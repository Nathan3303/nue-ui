...
const D = /* @__PURE__ */ x(X, [['render', ee]]),
    H = 'vitepress-demo-preview',
    M = (o, e, t, c) => {
        let l = e === '' ? `${o}` : `${o}-${e}`;
...
const se = /* @__PURE__ */ x(te, [['render', oe]]),
    ce = /* @__PURE__ */ $({
                                ...
                                l.value
                                    ? (a(),
                                      C(
                                          ...
                                          [Z(se), i('span', null, k(d.content), 1)],
                                          6
                                      ))
                                    : w('', !0)
                            ]),
    ...
    de = /* @__PURE__ */ $({
        ...
        setup(o) {
            const e = o,
                ...
                L = v(decodeURIComponent(e.code)),
                p = v(decodeURIComponent(e.showCode)),
                d = v(null),
                g = () => {
                    m(L.value), E.open();
                },
    ...
    pe = /* @__PURE__ */ $({
        ...
        setup(o) {
            const e = o,
                ...
                { isCodeFold: c, setCodeFold: l } = S(),
                { clickCopy: _ } = U(),
                m = v(decodeURIComponent(e.code)),
                L = v(decodeURIComponent(e.showCode)),
                p = v(null),
                d = () => {
                    _(m.value), E.open();
                },
                    ...
                    C(
                        ...
                        [
                            i(
                                'section',
                                {
                                    class: u([n(t).bem('preview'), 'vp-raw'])
                                },
                                [T(s.$slots, 'default')],
                                2
                            ),
